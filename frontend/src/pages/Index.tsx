...
+              <TabsTrigger value="resume-upload" className="text-lg font-medium">Resume Upload & Analysis</TabsTrigger>
             </TabsList>
             
-            <TabsContent value="profile-job" className="p-6">
+            <TabsContent value="resume-upload" className="p-6">
               <div className="text-center text-muted-foreground">
-                Upload your resume or build a new one with AI assistance
+                Upload your resume for detailed analysis and insights
               </div>
             </TabsContent>
           </Tabs>
         </Card>
...
+        {/* Upload Resume Section - Shows when tab is clicked */}
         {activeTab && (
